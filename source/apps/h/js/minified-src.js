...
///#/snippet commonAmdStart
	...
	'prev': function(selector, maxSiblings) {
		return this['trav']('previousSibling', selector, maxSiblings||1);
	},
	/*$
 	 * @id up
 	 * @group SELECTORS
	...
	*/
	'request': function (method, url, data, settings0) {
		...
		try {
			...
			xhr['open'](method, url, settings['sync'] ? false : true, settings['user'], settings['pass']);
