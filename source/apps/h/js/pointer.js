...
(function() {
    ...
    body.addEventListener('mouseover', pointerOver);
    ...
    {
        var evt = makePointerEvent('over', e);
    }
    ...
    function pointerUp(e) {
        ...
        // Hack to prevent double events on some phones
        var istouch  = e.type.indexOf('touch') === 0;
    
        if (!istouch && lastupwastouch)
        {
            lastwastouch  = 0;
            return;
        }
        
        lastupwastouch  = istouch;
